...
return new class extends Migration
{
    public function up(): void
    {
        ...
        throw_if(empty($tableNames), 'Error: permission config not loaded. Run [php artisan config:clear] and try again.');
        throw_if($teams && empty($columnNames['team_foreign_key'] ?? null), 'Error: team_foreign_key not loaded. Run [php artisan config:clear] and try again.');
